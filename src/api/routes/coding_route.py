...
def coding_model_endpoint(data:Parameters)->str:
    ...
    return ARInference(sp=tokenizer,model=model,prompt=data.code,reptition_penalty=data.repetition_penalty,top_p=data.top_p,max_length=data.max_length,temperature=data.temperature)